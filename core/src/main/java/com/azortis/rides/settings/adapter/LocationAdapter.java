...
package com.azortis.rides.settings.adapter;
...
public class LocationAdapter implements JsonSerializer<Location>, JsonDeserializer<Location> {
    ...
    public Location deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        LocationSettings locationSettings = gson.fromJson(json, LocationSettings.class);
        return locationSettings.getBukkitLocation();
    }

    @Override
    public JsonElement serialize(Location location, Type typeOfSrc, JsonSerializationContext context) {
        return gson.toJsonTree(new LocationSettings(location), LocationSettings.class);
    }
